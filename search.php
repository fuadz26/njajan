...
<body>
    ...
    ?>
        ...
        <div class="flex items-center mb-4 pt-5 ">
            <p
                class="  w-full  text-black  py-3 px-6 border-gray-300 shadow rounded focus:ring-green-500 focus:border-green-500">
    ...
    ?>
        ...
        ?>
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                id="addcart" class="block w-full py-1 text-center text-white bg-green-500 border border-green-500 rounded-b hover:bg-transparent hover:text-green-500 transition">Add
                    to cart</a>
            </div>
