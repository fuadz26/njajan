...
<body>
    <?php
        ...
        if (isset($_SESSION['errorMessages'])){
            ?>
            <p align="center"><strong><font color="#990000"><?php echo $_SESSION['errorMessages']; ?></font></strong></p>
    <?php
    ...
    <div class="contain py-16">
        <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
            ...
            <form action="asset/php/login_aksi.php" method="post" autocomplete="off">
                ...
                <div class="mt-4">
                    <button type="submit"
                        class="block w-full py-2 text-center text-white bg-green-500 border border-green-500 rounded hover:bg-transparent hover:text-green-500 transition uppercase font-roboto font-medium">Login</button>
                </div>
            </form>

            <p class="mt-4 text-center text-gray-600">Don't have account? <a href="regis.php"
                    class="text-green-500">Register
                    now</a></p>
        </div>
    </div>
    <!-- ./login -->
