            ...
            <div class=" flex items-center justify-between border gap-6 p-4 border-gray-200 rounded">
                <div class="w-1/3">
                    <div class=" flex-shrink-1">
                        <img src="<?php echo $row->user_img; ?>" alt="profile"
                            class="rounded-full w-72  h-72 border border-gray-200 p-1 object-cover">
                    </div>
                    <form action="upload.php" method="POST" enctype="multipart/form-data">
                        <input type="file" id="user_img" name="user_img" class="mt-2">
                        <button type="submit" name="upload"
                            class="px-4 py-2 mt-2 text-sm text-white bg-green-500 border border-green-500 rounded hover:bg-transparent hover:text-green-500 transition uppercase font-roboto font-medium">
                            Upload Foto</button>
                        
                            <a href="edit_user.php"
                                class="px-6 py-2 text-center text-sm text-white bg-green-500 border border-green-500 rounded hover:bg-transparent hover:text-green-500 transition uppercase font-roboto font-medium">
                                Edit</a>
                ...
                <div class=" pb-24 w-1/2">
                    ...
                    <p class="text-gray-500 text-lg"><?php echo $row->nama_lengkap; ?> <span
                    ...
                    <p class="text-gray-500 text-lg"><?php echo $row->nomor_telepon ?> <span
                            class="text-green-600"></span></p>
